...
b3psnr = cv.PSNR(b3, lena_grayscale_hq)
print("3x3 Box Filter PSNR: ",b3psnr)
b5psnr = cv.PSNR(b5, lena_grayscale_hq)
print("5x5 Box Filter PSNR:",b5psnr)

g3psnr = cv.PSNR(g3, lena_grayscale_hq)
print("3x3 Gaussian PSNR:",g3psnr)
g5psnr = cv.PSNR(g5, lena_grayscale_hq)
print("5x5 Gaussian PSNR:",g5psnr)

adap_mean_filtered_psnr = cv.PSNR(adap_mean_filtered, lena_grayscale_hq)
print("Adaptive mean filtered PSNR:",adap_mean_filtered_psnr)

bilateralfiltered_psnr = cv.PSNR(bilateralfiltered, lena_grayscale_hq)
...
b3_01psnr = cv.PSNR(b3_01, lena_grayscale_hq)
print("3x3 Box Filter PSNR: ",b3_01psnr)
b5_01psnr = cv.PSNR(b5_01, lena_grayscale_hq)
print("5x5 Box Filter PSNR:",b5_01psnr)

g3_01psnr = cv.PSNR(g3_01, lena_grayscale_hq)
print("3x3 Gaussian PSNR:",g3_01psnr)
g5_01psnr = cv.PSNR(g5_01, lena_grayscale_hq)
print("5x5 Gaussian PSNR:",g5_01psnr)

adap_mean_filtered_01_psnr = cv.PSNR(adap_mean_filtered_01, lena_grayscale_hq)
print("Adaptive mean filtered PSNR:",adap_mean_filtered_01_psnr)

bilateralfiltered_01_psnr = cv.PSNR(bilateralfiltered_01, lena_grayscale_hq)
